...
def MakeMIC(pwd, ssid, A, B, data, wpa = False):
    ...
    pmk = pbkdf2_hmac('sha1', pwd.encode('latin1'), ssid.encode('latin1'), 4096, 32)
...
if __name__ == "__main__":
    ...
    with open('/home/kerssen/Documentos/Cripto/lab3/rockyou_mod.dic', encoding='utf-8', errors='ignore') as f:
        S = []
        for l in f:
            S.append(l.strip())
